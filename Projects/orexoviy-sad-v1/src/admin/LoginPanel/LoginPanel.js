            ...
            <div className='login'>
                ...
                <form className='loginForm'>
                    <InputGroup>
                        ...
                        <Input type='text' ref={UserInp} focusBorderColor='none' _hover='' placeholder='Username' w='100%' borderColor='rgba(44, 159, 61, 1)' borderWidth='2px' />
                    </InputGroup>
                    <InputGroup>
                        ...
                        <Input type={passHide === true ? 'password' : 'text'} ref={PassInp} focusBorderColor='none' _hover='' borderRight='none' paddingRight='0' placeholder='Password' w='100%' borderColor='rgba(44, 159, 61, 1)' borderWidth='2px' />
                    ...
                    <span className='validation show'>Неверное имя пользователя или пароль.</span>
                    <Button className='singin'>Вход</Button>
                </form>
            </div>
        </div>
    );
